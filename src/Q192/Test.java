...
And given the requirements:
    ...
    * 3. Process alternating elements of the array in the order of entry. Which two statements are true?(Choosetwo.)
    ...
    E. Requirement 3 CANNOT be implemented by using either the enhanced for loop or the standardfor loop.
Answer: D E
*/
}
